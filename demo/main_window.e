...
feature {NONE} -- Initialization
	...
	initialize
		...
		do
			...
			extend (h_split)
			h_split.extend (v_split)
			h_split.extend (hsb_tweeker_view)
			v_split.extend (hsb_spectrum_view)
			v_split.extend (html_colors_view)


--			split_manager.enable_mode_changes
--			split_manager.set_horizontal
--			split_manager.extend (hsb_spectrum_view)
--			split_manager.extend (hsb_color_summations_view)
--			split_manager.set_vertical
--			split_manager.extend (html_colors_view)
--			split_manager.set_horizontal
--			split_manager.extend (hsb_tweeker_view)
				-- Position scrollbars
